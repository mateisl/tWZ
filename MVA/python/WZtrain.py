...
# MVA configuration
from tWZ.MVA.WZmva          import sequence, read_variables, mva_variables, all_mva_variables 
from tWZ.MVA.WZmva          import * 
...
trainer.plotEvaluation(plot_directory = os.path.join( plot_directory, "MVA", "WZ_3l_allVars") )
