...
do
  ...
  do
    ...
    do
      ...
      # combine -M MultiDimFit topEFT_${WCname}_1_13TeV_${i}.root -n .part3E_${i}_1_${WCname} --saveNLL --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --freezeParameters r  --cminDefaultMinimizerStrategy=0 --cminDefaultMinimizerTolerance=0.0001 --expectSignal=1 --algo=fixed --fixedPointPOIs r=0
      echo '--------------------------------------------------------------------'
