...
# with command line options: Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGENAPV-00001-fragment.py --python_filename SMP-RunIISummer20UL16wmLHEGENAPV-00001_1_cfg.py --eventcontent NANOAODGEN --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --fileout file:SMP-RunIISummer20UL16wmLHEGENAPV-00001.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SMP-RunIISummer20UL16wmLHEGENAPV-00001-fragment.py nevts:50000'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:tWZ01j-vec_newMatching_nJetMax0.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/users/dennis.schwarz/CMSSW_10_6_20/src/tWZ01j/tWZ01j-vec_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
