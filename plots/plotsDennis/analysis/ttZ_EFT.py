...
argParser.add_argument('--plot_directory', action='store', default='ttZ_EFT_v1')
...
if args.era == "Run2016":
    ...
    if args.SMEFTsim:
        mc = [Autumn18.TWZ_NLO_DR, SMEFTsim_fast.ttZ01j, Autumn18.TTX_rare, Autumn18.TZQ, Autumn18.WZ, Autumn18.triBoson, Autumn18.ZZ, Autumn18.nonprompt_3l]

elif args.era == "RunII":
    mc = [TWZ_NLO_DR, TTZ, TTX_rare, TZQ, WZ, triBoson, ZZ, nonprompt_3l]

signal_idx = 1 # INDEX OF ttZ sample
################################################################################
# EFT reweight
...
for mode in ["comb1","comb2","all"]:
    ...
    if mode == "all":
        ...
        outfile_MVA = ROOT.TFile(plot_dir+'/MVA_score.root', 'recreate')
        outfile_MVA.cd()
        for plot in plots:
