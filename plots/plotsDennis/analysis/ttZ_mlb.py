...
argParser.add_argument('--plot_directory', action='store', default='ttZ_mlb_v1')
...
params =  []
params.append({'legendText':'cHq1Re33=2, cHq3Re33=0', 'color':ROOT.kCyan,       'WC':{'cHq1Re33':2.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=-2, cHq3Re33=0', 'color':ROOT.kMagenta,    'WC':{'cHq1Re33':-2.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=0, cHq3Re33=2', 'color':ROOT.kGreen+2,    'WC':{'cHq3Re33':2.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=0, cHq3Re33=-2', 'color':ROOT.kViolet-9,   'WC':{'cHq3Re33':-2.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=10, cHq3Re33=10', 'color':ROOT.kAzure+7,    'WC':{'cHq1Re33':10.0, 'cHq3Re33':10.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=2, cHq3Re33=2', 'color':ROOT.kBlue,       'WC':{'cHq1Re33':2.0, 'cHq3Re33':2.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=-2, cHq3Re33=-2', 'color':ROOT.kOrange-3,   'WC':{'cHq1Re33':-2.0, 'cHq3Re33':-2.0} , 'sample': sample_eft})
params.append({'legendText':'cHq1Re33=-10, cHq3Re33=-10', 'color':ROOT.kRed,        'WC':{'cHq1Re33':-10.0, 'cHq3Re33':-10.0} , 'sample': sample_eft})
params.append({'legendText':'SM', 'color':ROOT.kBlack,       'WC':{} , 'sample': sample_eft})
...
for i_mode, mode in enumerate(allModes):
    ...
    if not args.noData:
        if len(mc) > 0:
            ...
            stack = Stack(data_sample, *[ [ param['sample'] ] for param in params ])
            noneftidxs = [0]
    else:
        if len(mc) > 0:
