...
tWZ_ud_match.weight     = lambda event, sample: event.ud_match*event.weight
tWZ_gluon_match.weight  = lambda event, sample: event.gluon_match*event.weight
tWZ_other_match.weight  = lambda event, sample: event.other_match*event.weight
