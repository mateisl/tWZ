...
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTWToLNu #SPLIT7
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTWToQQ #SPLIT3
###python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTW_LO #SPLIT20
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTZToLLNuNu #SPLIT15
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTZToLLNuNu_m1to10 #SPLIT2
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTZToQQ #SPLIT2
###python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTZ_LO #SPLIT20
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTHbbLep #SPLIT10
#python nanoPostProcessing.py  --forceProxy --skim dilep --year 2018 --processingEra tWZ_nAODv6_private_v4 --sample TTHnobb_pow #SPLIT12
