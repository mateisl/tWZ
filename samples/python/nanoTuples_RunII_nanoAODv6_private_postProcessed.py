...
Top          = Sample.combine( "Top", [Summer16.Top, Fall17.Top, Autumn18.Top], texName = "t/t#bar{t}")
TTLep        = Sample.combine( "TTLep", [Summer16.TTLep, Fall17.TTLep, Autumn18.TTLep],texName = "t#bar{t}")

TTTT       = Sample.combine( "TTTT", [Summer16.TTTT, Fall17.TTTT, Autumn18.TTTT], texName = "t#bar{t}t#bar{t}")
TTW        = Sample.combine( "TTW", [Summer16.TTW, Fall17.TTW, Autumn18.TTW], texName = "t#bar{t}W")
TTZ        = Sample.combine( "TTZ", [Summer16.TTZ, Fall17.TTZ, Autumn18.TTZ], texName = "t#bar{t}Z")
DY       = Sample.combine("DY", [Summer16.DY, Fall17.DY, Autumn18.DY], texName = "Drell-Yan")
